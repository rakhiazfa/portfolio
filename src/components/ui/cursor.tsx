...
const Cursor = () => {
    ...
    return (
        <div
            ref={cursorFollower}
            className="absolute z-[-1] top-0 left-0 blur-3xl brightness-125 contrast-75 drop-shadow-xl grayscale-0 hue-rotate-180 backdrop-blur-xl backdrop-brightness-125 backdrop-opacity-50 backdrop-saturate-125 backdrop-sepia"
        >
